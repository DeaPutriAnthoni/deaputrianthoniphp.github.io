<nav>
    <div class="logo">
        <h1 id="logo">IceCreamDey .</h1>
    </div>
    <ul class="list-item">
        <li><a href="index.php">Home</a></li><hr>
        <li><a href="product.php">Products</a></li><hr>
